...
public class Collides
{
    ...
    private static CollisionSide CollidePostPhysics(PhysicsObject physicsObject, PhysicsObject other)
    {
        ...
        CollisionSide side = Collides.CheckIfCollision(physicsObject, other);
        if (side == CollisionSide.None)
        {
        ...
        switch (side)
        {
            case CollisionSide.Left:
                physicsObject.Position.X = other.Position.X + other.Collider.Rect.Width;
            ...
            case CollisionSide.Right:
                physicsObject.Position.X = other.Position.X - physicsObject.Collider.Rect.Width;
                if (physicsObject.Velocity.X < 0)
                {
                    physicsObject.Velocity.X = 0;
                }
            ...
            case CollisionSide.Top:
                physicsObject.Position.Y = other.Position.Y + other.Collider.Rect.Height;
            ...
            case CollisionSide.Bottom:
                physicsObject.Position.Y = other.Position.Y - physicsObject.Collider.Rect.Height;
                if (physicsObject.Velocity.Y > 0)
                {
                    physicsObject.Velocity.Y = 0;
                }
    ...
    /// <returns></returns>
    private static CollisionSide CheckIfCollision(PhysicsObject physicsObject, PhysicsObject other)
    {
        if (!Collides.RectVsRect(physicsObject, other))
        {
            return CollisionSide.None;
        }
        float overlapX = Math.Min(
            physicsObject.Position.X + physicsObject.Collider.Rect.Width - other.Position.X,
            other.Position.X + other.Collider.Rect.Width - physicsObject.Position.X
        );

        float overlapY = Math.Min(
            physicsObject.Position.Y + physicsObject.Collider.Rect.Height - other.Position.Y,
            other.Position.Y + other.Collider.Rect.Height - physicsObject.Position.Y
        );
    ...
    {
        return physicsObject.Position.X < other.Position.X + other.Collider.Rect.Width &&
               physicsObject.Position.X + physicsObject.Collider.Rect.Width > other.Position.X &&
               physicsObject.Position.Y < other.Position.Y + other.Collider.Rect.Height &&
               physicsObject.Position.Y + physicsObject.Collider.Rect.Height > other.Position.Y;
    }
