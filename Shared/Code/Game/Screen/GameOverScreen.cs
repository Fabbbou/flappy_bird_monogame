...
public class GameOverScreen : GameScreen
{
    ...
    public override void Initialize()
    {
        ...
        _entity = new Entity();
        _playButtonClickHandler = new ClickableRegionHandler(_entity, _camera, OnClickPlay, new(SPRITE_POSITION_PLAY_BUTTON.ToPoint(), ATLAS_SIZE_PLAY_BUTTON.ToPoint()));
        _scoreButtonClickHandler = new ClickableRegionHandler(_entity, _camera, OnClickScore, new(SPRITE_POSITION_SCORE_BUTTON.ToPoint(), ATLAS_SIZE_SCORE_BUTTON.ToPoint()));
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        _spriteBatch.Draw(_playButtonTexture, SPRITE_POSITION_PLAY_BUTTON, Color.White);
        _spriteBatch.Draw(_scoreButtonTexture, SPRITE_POSITION_SCORE_BUTTON, Color.White);
