...
public class PreloadedAssets
{
    ...
    private void LoadAtlas(ContentManager content)
    {
        ...
        PauseButton = _mainGameAtlas.CreateRegion((int)ATLAS_PAUSE_BUTTON.X, (int)ATLAS_PAUSE_BUTTON.Y, (int)SIZE_PAUSE_BUTTON.X, (int)SIZE_PAUSE_BUTTON.Y, "PauseButton");
        OkButton = _mainGameAtlas.CreateRegion((int)ATLAS_OK_BUTTON.X, (int)ATLAS_OK_BUTTON.Y, (int)SIZE_OK_BUTTON.X, (int)SIZE_OK_BUTTON.Y, "OkButton");
        MenuButton = _mainGameAtlas.CreateRegion((int)ATLAS_MENU_BUTTON.X, (int)ATLAS_MENU_BUTTON.Y, (int)SIZE_MENU_BUTTON.X, (int)SIZE_MENU_BUTTON.Y, "MenuButton");
        BarSound = _mainGameAtlas.CreateRegion((int)ATLAS_BAR_SOUND.X, (int)ATLAS_BAR_SOUND.Y, (int)SIZE_BAR_SOUND.X, (int)SIZE_BAR_SOUND.Y, "BarSound");
